...
| `HC_LANGUAGE` | Mandatory language | the posting states a required language/proficiency level clearly enough for the approved rule | `unknown` when candidate level or job level is unclear; scale-aware comparison per D-046 (proposed) |
...
**END OF PROJECT CONTEXT - v0.4.12-draft.**
